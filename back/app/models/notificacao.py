...
class Notificacao:
    ...
    def enviar(self):
        ...
        notificacao = {
            "to": "cocU4X_PrhwDGEtX2Hqfif:APA91bEe7oXmu12thGldMf1gbsKQU8l23RtKurflHl9pUIAJydjuEyNaDUKAI3_DzHQzNKua3gODIhmx1FZmbrjPCH5pL740nc9DiFVF8zLQtXimWHvQ4pehkS_abjyxizN-FJjgZPOa",
            "notification": {
                "title": "%s" % self.titulo,
